...
--- Bir üst satırda student_age_check kısmına 0 ile 20 arasına bir değer girmeyi kısıtlama getirir bunu check ile yaparız
);
...
--- update olarak değiştireceğin studentste  atama değerini set olarak koşuluyla birlikte değiştirdik